...
2026-06-17: Slovak history thread authored and deployed. 9 new concepts: Cyril and Methodius (863), Great Moravia (885), Kingdom of Hungary (1000), Habsburg Monarchy (1526), Ludovit Stur (1843), Austria-Hungary (1867), Czechoslovakia 1918, Slovak National Uprising (1944), Prague Spring (1968). New thread "Slovakia through the centuries" (16 members, 8 tier-1 anchors). imageUrl field added to Concept/BankConcept; Brief.tsx shows Wikimedia thumbnail on first encounter (onError silent fallback); Workbox runtime-caches Wikimedia Commons URLs (CacheFirst 30 days). BANK_VERSION v6. Schema at Dexie v3 (no change -- imageUrl is not indexed). NEXT: FSRS-stability-gated tier unlock; light Daylight theme; verify Wikimedia imageUrl strings for concepts that have them.
