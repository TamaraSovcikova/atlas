  ...
  return (
    <Drawer.Root open={open} onOpenChange={setOpen} direction="top">
      <Drawer.Trigger asChild>
        <button
          type="button"
          className="group flex w-full items-center gap-3 rounded-2xl border border-ink/[0.08] bg-bg-soft px-4 py-2.5 text-left shadow-card transition-colors hover:border-accent/40"
        >
      ...
      <Drawer.Portal>
        ...
        <Drawer.Content className="fixed inset-x-0 top-0 z-50 mx-auto flex max-h-[85vh] max-w-2xl flex-col rounded-b-3xl border-b border-ink/[0.10] bg-bg-soft shadow-raised outline-none">
